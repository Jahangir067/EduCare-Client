        ...
        <div className="my-8">
...

            {
                colleges.map(college => <div className="grid grid-cols-1 divide-y w-full border p-2" key={college._id}>
                    <Link to={`/collegeDetails/${college._id}`} className="card card-side bg-white cursor-pointer ps-4">
                        <figure>
                            <img className="h-24 w-24 p-4 border" src={college.collegeImg} alt="College" />
                        </figure>
